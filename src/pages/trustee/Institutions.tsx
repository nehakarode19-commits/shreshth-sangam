...
export default function TrusteeInstitutions() {
  const { user } = useAuth();
  ...
  return (
    <DashboardLayout
      ...
      currentPath="/trustee/institutions"
      userName={user?.email || "Trustee"}
      userPhone="+91 98765 43210"
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-bold text-foreground mb-2">Institutions</h2>
          <p className="text-muted-foreground">Manage institutions under your oversight</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">Institution management features coming soon...</p>
          </CardContent>
        </Card>
      </div>
    </DashboardLayout>
