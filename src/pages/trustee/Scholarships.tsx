...
export default function TrusteeScholarships() {
  const { user } = useAuth();
  ...
  return (
    <DashboardLayout
      ...
      currentPath="/trustee/scholarships"
      userName={user?.email || "Trustee"}
      userPhone="+91 98765 43210"
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-bold text-foreground mb-2">Avail Scholarship</h2>
          <p className="text-muted-foreground">Scholarship opportunities and applications</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">Scholarship details and application process coming soon...</p>
          </CardContent>
        </Card>
      </div>
    </DashboardLayout>
